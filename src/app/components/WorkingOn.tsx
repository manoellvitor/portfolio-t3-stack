...
import futureProjects from "../../projects_data/FutureProject";

function WorkingOn() {
  return (
    <section className="mt-10 flex flex-col items-center justify-evenly gap-6 md:items-start md:gap-2">
      <div className="flex flex-col items-center gap-4">
        <h1 className="font-ocra text-2xl text-blue-500">
          <span className="text-zinc-300">{"<"}</span>Working On
      ...
      <div className="md:grid-row-2 mt-2 grid w-full gap-3 lg:grid-flow-col">
        {futureProjects.map((project) => {
          return (
            <Card
              key={project.id}
              className="flex min-w-[33%] flex-col items-center rounded-md border-2 border-cyan-400 px-4 py-2 lg:mx-auto lg:max-w-[50%]"
            >
